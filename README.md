# [full stack proxy nginx Symfony for everyone with docker compose](https://github.com/damalis/full-stack-proxy-nginx-symfony-for-everyone-with-docker-compose)

If You want to build a reverse proxy website with Symfony at short time;

#### Full stack Proxy Nginx Symfony:
[![Symfony](https://img.shields.io/badge/Symfony-000?style=flat&logo=symfony&logoColor=white)](https://www.symfony.com/)
...
```
git clone https://github.com/damalis/full-stack-proxy-nginx-symfony-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-nginx-symfony-for-everyone-with-docker-compose
chmod +x install.sh
...
The containers are now built and running. You should be able to access the Symfony installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
...
<tbody>
  <tr>
    <td>MariaDB</td>
    <td><code>DATABASE_URL="mysql://{DB_USER}:{DB_PASSWORD}@database:3306/{DB_NAME}?serverVersion=10.11.2-MariaDB&charset=utf8mb4"</code></td>
  </tr>
  <tr>
    <td>MySQL</td>
	<td><code>DATABASE_URL="mysql://{DB_USER}:{DB_PASSWORD}@database:3306/{DB_NAME}?serverVersion=8.0.32&charset=utf8mb4"</code></td>
  </tr>
  <tr>    
    <td>PostgreSQL</td>
    <td><code>#DATABASE_URL="postgresql://app:!ChangeMe!@127.0.0.1:5432/app?serverVersion=16&charset=utf8"</code></td>
  </tr>
</tbody>
</table>
